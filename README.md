...
Students should use **Python 3.13** and install the pinned packages from [`requirements.txt`](requirements.txt). See [week1/setting_up_environment.md](week1/setting_up_environment.md) for setup instructions.
